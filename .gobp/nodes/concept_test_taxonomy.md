...
definition: "GoBP organizes software tests into 3 levels: Level 1 (universal) \u2014\
  \ applies to all projects, pre-seeded on init; Level 2 (platform) \u2014 specific\
  \ to Flutter, Deno, Web, etc., added by project; Level 3 (project) \u2014 custom\
  \ kinds unique to this project. TestKind nodes define categories. TestCase nodes\
  \ are individual test instances."
extensible: true
...
description: "GoBP organizes software tests into 3 levels: Level 1 (universal) \u2014\
  \ applies to all projects, pre-seeded on init; Level 2 (platform) \u2014 specific\
  \ to Flutter, Deno, Web, etc., added by project; Level 3 (project) \u2014 custom\
  \ kinds unique to this project. TestKind nodes define categories. TestCase nodes\
  \ are individual test instances."

...
**Chỉ mục & snapshot dự án (v2, 93 loại node, batch + viewer):** [`docs/README.md`](README.md).
...
|--------|--------|---------|
| `create:` | `Type: Name \| Description` **hoặc** `Type: Name \| plain text key="value" key2='…'` | Tạo node — gộp field tên; **thiếu `id`** → server gán id v2 (trừ loại đặc biệt như Session/TestCase) |
